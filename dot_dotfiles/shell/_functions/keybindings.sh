verkeys() {
    ...
    cat "/mnt/Nueva/Applications/AppImage/keybindings.txt" | sed '1,2d' | \
...
#verkeys() {
#    cat "/mnt/Nueva/Applications/AppImage/keybindings.md" | fzf --height 40% --reverse --header "Buscador de Atajos"
#}
